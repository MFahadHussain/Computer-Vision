...
class USBRelay:
    ...
    def relay_on(self):
        if self.ser:
            # ⚠️ Example command, may differ per relay
...
relay = USBRelay(port="/dev/tty.usbserial-110")  # update with your relay device path
...
# ---------------- Load Models ----------------
yolo_model = YOLO("license_plate_detector.pt")  # replace with your YOLO model
