...
def safe_open_barrier(reason: str = "", face_name: str = None, plate_number: str = None, 
    ...
    threading.Thread(
        ...
        args=(reason, face_name, plate_number, face_authorized, plate_authorized),
        daemon=True
    ).start()

def _open_barrier_thread(reason: str, face_name: str, plate_number: str, 
                        face_authorized: bool, plate_authorized: bool):
    try:
...
<head>
  ...
  <title>AI Security Dashboard – Face + Pakistan Plate</title>
...
<body>
  <div class=\"container\">
    ...
    <div class=\"grid\">
      ...
      <div class=\"panel\" style=\"grid-column:1 / -1\">
        <div class=\"panel-header\"><div class=\"panel-title\">Authorized Pakistan Plates</div>
          <div class=\"flex\">
