...
def main():
    ...
    try:
        parser = argparse.ArgumentParser(
            description="Enhanced YOLO-World V2 Video Detector with Multiple Polygon ROI Cropping, Editing, and BoT-SORT Tracking (Supervision 0.27.0+)",
...
Examples:
  ...
  python main.py -i video.mp4 -o output.mp4 --conf 0.5
        ...
        parser.add_argument(
            '--no-tracking',
            action='store_true',
            help='Disable tracking and use detection only'
        )
