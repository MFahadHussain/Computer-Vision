...
Enhanced YOLO-World V2 Video Detector with Multiple Polygon ROI Cropping, Editing, and BoT-SORT Tracking (Supervision 0.27.0+)
...
- `--no-tracking`: Disable tracking and use detection only
...
- Wraps BoT-SORT tracker from supervision library
- Falls back to ByteTrack if BoT-SORT fails
- Handles parameter mapping for Supervision 0.27.0+
